function ifEntityFilterIsChosenShowItsValuesIfNotHideThem(filterFieldSelector) {
    ...
    if ($(filterFieldSelector).val() === 'employmentContract') {
        enableInput(filterFieldSelector,'.filter-value-employment-contract');
        disableInput(filterFieldSelector,'.filter-value-job-designation');
        disableInput(filterFieldSelector,'.filter-value-text');
        disableInput(filterFieldSelector,'.filter-value-learning-support-team');
        return false;
    }

    if ($(filterFieldSelector).val() === 'jobDesignation') {
        enableInput(filterFieldSelector,'.filter-value-job-designation');
        disableInput(filterFieldSelector,'.filter-value-employment-contract');
        disableInput(filterFieldSelector,'.filter-value-text');
        disableInput(filterFieldSelector,'.filter-value-learning-support-team');
        return false;
    }
